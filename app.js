...
const productResources = {
  ...
  'cursor': [
    ...
    { label: '文档', title: 'Cursor Docs', href: 'https://docs.cursor.com' }
  ],
  'factory-droid-cli': [
  ...
  'cc-switch': [
    ...
    { label: '教程来源', title: 'Golden-Promise/vscode-cc-switch', href: 'https://github.com/Golden-Promise/vscode-cc-switch' }
  ],
  'cherry-studio': [
...
const productScreenshots = {
  'openclaw': [
    { title: 'OpenClaw 图文步骤 1', detail: '选择 yes 继续安装。', src: 'images/openclaw-guide/image2.png', alt: 'OpenClaw 部署截图 1' },
    { title: 'OpenClaw 图文步骤 2', detail: '选择快速开始。', src: 'images/openclaw-guide/image3.png', alt: 'OpenClaw 部署截图 2' },
    { title: 'OpenClaw 图文步骤 3', detail: '选择自定义提供商，把词元.fast 当作兼容模型网关接入。', src: 'images/openclaw-guide/image4.png', alt: 'OpenClaw 部署截图 3' },
    { title: 'OpenClaw 图文步骤 4', detail: '填写 URL：OpenClaw 这里填 https://ciyuan.fast，不要加 /v1。', src: 'images/openclaw-guide/image5.png', alt: 'OpenClaw 部署截图 4' },
    { title: 'OpenClaw 图文步骤 5', detail: '粘贴词元.fast API Key。', src: 'images/openclaw-guide/image6.png', alt: 'OpenClaw 部署截图 5' },
    { title: 'OpenClaw 图文步骤 6', detail: '选择 OpenAI 格式。', src: 'images/openclaw-guide/image7.png', alt: 'OpenClaw 部署截图 6' },
    { title: 'OpenClaw 图文步骤 7', detail: '填写模型名称，例如 gpt-5.3-codex 或控制台可用模型。', src: 'images/openclaw-guide/image8.png', alt: 'OpenClaw 部署截图 7' },
    { title: 'OpenClaw 图文步骤 8', detail: '连接 App 的步骤可以先跳过。', src: 'images/openclaw-guide/image9.png', alt: 'OpenClaw 部署截图 8' },
    { title: 'OpenClaw 图文步骤 9', detail: '选择官方技能，不确定时先选推荐技能。', src: 'images/openclaw-guide/image10.png', alt: 'OpenClaw 部署截图 9' },
    { title: 'OpenClaw 图文步骤 10', detail: '包管理器推荐 npm。', src: 'images/openclaw-guide/image11.png', alt: 'OpenClaw 部署截图 10' },
    { title: 'OpenClaw 图文步骤 11', detail: '额外 API 能力不确定时先选 no。', src: 'images/openclaw-guide/image12.png', alt: 'OpenClaw 部署截图 11' },
    { title: 'OpenClaw 图文步骤 12', detail: '如果已开通生图、笔记、语音等能力，可按需开启。', src: 'images/openclaw-guide/image13.png', alt: 'OpenClaw 部署截图 12' },
    { title: 'OpenClaw 图文步骤 13', detail: '确认配置并 restart。', src: 'images/openclaw-guide/image14.png', alt: 'OpenClaw 部署截图 13' },
    { title: 'OpenClaw 图文步骤 14', detail: '进入对话框后先测试一句简单消息。', src: 'images/openclaw-guide/image15.png', alt: 'OpenClaw 部署截图 14' },
    { title: 'OpenClaw 图文步骤 15', detail: '检查 dashboard 是否能正常打开。', src: 'images/openclaw-guide/image16.png', alt: 'OpenClaw 部署截图 15' },
    { title: 'OpenClaw 图文步骤 16', detail: '检查状态与网关连接。', src: 'images/openclaw-guide/image17.png', alt: 'OpenClaw 部署截图 16' },
    { title: 'OpenClaw 图文步骤 17', detail: '查看技能和应用连接状态。', src: 'images/openclaw-guide/image18.png', alt: 'OpenClaw 部署截图 17' },
    { title: 'OpenClaw 图文步骤 18', detail: '确认模型回复可用。', src: 'images/openclaw-guide/image19.png', alt: 'OpenClaw 部署截图 18' },
    { title: 'OpenClaw 图文步骤 19', detail: '完成部署后按日常命令维护。', src: 'images/openclaw-guide/image20.png', alt: 'OpenClaw 部署截图 19' }
  ],
  'claude-code': [
  ...
  'cc-switch': [
    { title: '获取模型名称', detail: '在词元.fast 控制台确认要使用的模型 ID。', src: 'images/cc-switch/claude-code-tutorial-10.png', alt: 'CC Switch 获取模型名称' },
    { title: '确认接口地址', detail: '词元.fast 的 Base URL 使用 https://ciyuan.fast。', src: 'images/cc-switch/claude-code-tutorial-11.png', alt: 'CC Switch 确认 Base URL' },
    { title: '添加供应商', detail: '回到 cc-Switch 客户端，点击添加新的服务供应商。', src: 'images/cc-switch/claude-code-tutorial-12.png', alt: 'CC Switch 添加供应商' },
    { title: '进入配置页面', detail: '按照图中入口进入 Provider 配置页。', src: 'images/cc-switch/claude-code-tutorial-13.png', alt: 'CC Switch 进入 Provider 配置' },
    { title: '填写接口信息', detail: '粘贴词元.fast Base URL 与 API Key。', src: 'images/cc-switch/claude-code-tutorial-14.png', alt: 'CC Switch 填写接口信息' },
    { title: '填写模型信息', detail: '填写词元.fast 控制台可用的模型名称。', src: 'images/cc-switch/claude-code-tutorial-15.png', alt: 'CC Switch 填写模型信息' },
    { title: '核对并添加', detail: '确认核心字段无误后点击添加。', src: 'images/cc-switch/claude-code-tutorial-16.png', alt: 'CC Switch 核对并添加 Provider' },
    { title: '启动 Claude Code', detail: '重新打开 VS Code 中的 Claude Code 扩展，进入对话即表示配置完成。', src: 'images/cc-switch/claude-code-tutorial-17.png', alt: 'CC Switch 启动 Claude Code' },
    { title: '开启本地代理', detail: '远程 SSH 场景先在 cc-Switch 中开启本地代理。', src: 'images/cc-switch/claude-code-tutorial-18.png', alt: 'CC Switch 开启本地代理 1' },
    { title: '记录代理地址', detail: '记住生成的服务地址与端口。', src: 'images/cc-switch/claude-code-tutorial-19.png', alt: 'CC Switch 开启本地代理 2' },
    { title: '打开终端', detail: '点击图中入口打开终端。', src: 'images/cc-switch/claude-code-tutorial-20.png', alt: 'CC Switch 打开终端' },
    { title: '复制代理配置', detail: '检查 .claude/settings.json 中的代理信息。', src: 'images/cc-switch/claude-code-tutorial-21.png', alt: 'CC Switch 复制代理配置' },
    { title: '编辑 SSH 配置', detail: '在 VS Code Remote - SSH 配置文件中加入 RemoteForward。', src: 'images/cc-switch/claude-code-tutorial-22.png', alt: 'CC Switch 编辑 SSH 配置 1' },
    { title: '添加 RemoteForward', detail: '按图中格式补充端口转发配置。', src: 'images/cc-switch/claude-code-tutorial-23.png', alt: 'CC Switch 编辑 SSH 配置 2' },
    { title: '安装远程扩展', detail: '在远程服务器侧安装 Claude Code 扩展。', src: 'images/cc-switch/claude-code-tutorial-24.png', alt: 'CC Switch 安装远程 Claude Code 扩展' },
    { title: '配置远程扩展', detail: '进入远程 Claude Code 扩展的环境配置。', src: 'images/cc-switch/claude-code-tutorial-25.png', alt: 'CC Switch 配置远程扩展' },
    { title: '写入代理地址', detail: '把本地代理地址和密钥写入远程扩展配置。', src: 'images/cc-switch/claude-code-tutorial-26.png', alt: 'CC Switch 写入远程代理地址' },
    { title: '远程运行完成', detail: '点击远程环境里的 Claude Code 图标，能进入对话即表示成功。', src: 'images/cc-switch/claude-code-tutorial-111.png', alt: 'CC Switch 远程运行完成' }
  ],
  'cherry-studio': [
...
/model</code></pre><p>启动后先问一句简单问题，再让它读取当前目录文件。确认模型、权限、沙箱策略都正常后，再交给它做真实修改。</p>
  ...
  },
  {
    ...
    summary: 'Cursor 中转 API 配置教程：按原文中转 API 顺序配置 Base URL、API Key、Verify、添加 cursor 专属模型并验证 Claude Sonnet 3.5。',
    body: `
      <h2>Cursor 中转 API 配置</h2>
      <p class="lead">由于 Cursor IDE 原生只支持配置 ChatGPT 的 API Base URL，无法直接使用 Anthropic Claude 的 API。我们需要在 Cursor 的 OpenAI API Key 配置里接入词元.fast 中转接口，用到两个值：Base URL 和 API Key。</p>
      <h3>一、填写中转 API 地址</h3>
      <p>打开 Cursor 设置，进入模型配置区域，找到 <strong>OpenAI API Key</strong> 配置界面。Base URL 填写词元.fast 的 OpenAI 兼容地址：</p>
      <pre><code>Base URL: https://ciyuan.fast/v1
API Key: sk-xxxxxxxx</code></pre>
      <figure class="shot doc-shot"><img src="images/cursor/openai-api-config.png" alt="Cursor 设置界面 - 配置 API 密钥和基础 URL" loading="lazy" data-full="images/cursor/openai-api-config.png"><figcaption>Cursor 设置界面 - 配置 API 密钥和基础 URL</figcaption></figure>
      <h3>二、创建并复制词元.fast API Key</h3>
      <p>打开 <a href="https://ciyuan.fast/keys" target="_blank" rel="noreferrer">词元.fast API 密钥页面</a>，点击左侧 <strong>API 密钥</strong>，再点击右上角 <strong>创建密钥</strong>。创建成功后复制你的专属 Key，粘贴到 Cursor 的 API Key 输入框。</p>
      <p>平台里的 Key 通常以 <code>sk-</code> 开头。复制时不要带空格，也不要把截图里的示例 Key 当成真实 Key 使用。</p>
      <figure class="shot doc-shot"><img src="images/ciyuan-api-key.png" alt="词元.fast API 密钥创建与复制" loading="lazy" data-full="images/ciyuan-api-key.png"><figcaption>词元.fast API 密钥创建与复制</figcaption></figure>
      <h3>三、Verify 验证并打开开关</h3>
      <p>Base URL 和 API Key 都填写完成后，点击 <strong>Verify</strong>。验证成功后，打开 OpenAI API Key 对应开关，让 Cursor 后续请求走词元.fast 接口。</p>
      <p>如果 Verify 失败，优先检查 <code>https://ciyuan.fast/v1</code> 是否带了 <code>/v1</code>，再检查 API Key 是否复制完整。</p>
      <h3>四、添加 Cursor 专属模型</h3>
      <p>验证成功后，在模型列表里添加 Cursor 专属模型：</p>
      <pre><code>cursor-3-5-sonnet-20240620</code></pre>
      <p>如果词元.fast 控制台给你的可用模型名不同，以控制台实际开通的模型 ID 为准；但教程顺序上先按这个 Cursor 专属模型完成验证。</p>
      <figure class="shot doc-shot"><img src="images/cursor/model-add.png" alt="Cursor 专属模型添加" loading="lazy" data-full="images/cursor/model-add.png"><figcaption>Cursor 专属模型添加</figcaption></figure>
      <h3>五、选择模型并开始使用</h3>
      <p>添加完成后，回到 Cursor 模型选择界面，选中刚添加的 <code>cursor-3-5-sonnet-20240620</code>。之后在聊天或 Composer 面板里发起一次简单请求，确认模型能正常回复。</p>
      <figure class="shot doc-shot"><img src="images/cursor/model-select.png" alt="Cursor 模型选择界面" loading="lazy" data-full="images/cursor/model-select.png"><figcaption>Cursor 模型选择界面</figcaption></figure>
      <h3>六、验证是否为 Claude Sonnet 3.5</h3>
      <p>最后询问模型身份或能力，确认返回结果对应 Claude Sonnet 3.5。能正常返回说明配置已经成功，后续即可在 Cursor 中使用该模型辅助代码编写。</p>
      <figure class="shot doc-shot"><img src="images/cursor/claude-sonnet-verify.png" alt="Claude Sonnet 3.5 验证结果" loading="lazy" data-full="images/cursor/claude-sonnet-verify.png"><figcaption>Claude Sonnet 3.5 验证结果</figcaption></figure>
      <p>验证成功。</p>
    `
  },
  {
  ...
  },
  {
    ...
    body: `
      ...
      <h2>通过 cc-Switch 调用词元.fast 模型</h2>
      <h3>原理解析</h3>
      <p>cc-Switch 会帮你维护 Claude Code 所需的 Provider 配置，核心是动态写入 <code>ANTHROPIC_BASE_URL</code> 和 <code>ANTHROPIC_API_KEY</code>。Claude Code 原本发往官方接口的请求，会被切换到你配置的词元.fast 接口。</p>
      <ul><li><strong>不用手动编辑复杂配置</strong>：把常用 API 方案保存为 Provider，需要时一键切换。</li></ul>
      <ul><li><strong>适合多模型工作流</strong>：同一个 cc-Switch 中可保存不同模型、不同端点，便于在 Claude Code 场景里快速试用。</li></ul>
      <h3>前置准备</h3>
      <p>开始配置前，先准备三项信息：<strong>API Key</strong>、<strong>Base URL</strong>、<strong>模型名称</strong>。</p>
      <h4>1. 创建并复制词元.fast API Key</h4>
      <p>打开 <a href="https://ciyuan.fast/keys" target="_blank" rel="noreferrer">词元.fast API 密钥页面</a>，创建一个专用于 Claude Code / cc-Switch 的密钥。创建成功后立刻复制，后面会粘贴到 cc-Switch 的 API Key 字段。</p>
      <figure class="shot doc-shot"><img src="images/ciyuan-api-key.png" alt="词元.fast API 密钥创建与复制" loading="lazy" data-full="images/ciyuan-api-key.png"><figcaption>词元.fast API 密钥创建与复制</figcaption></figure>
      <h4>2. 获取模型名称</h4>
      <p>进入词元.fast 控制台的模型列表，选择你要给 Claude Code 使用的模型，复制模型 ID。模型名称必须和控制台显示一致。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-10.png" alt="CC Switch 获取模型名称" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-10.png"><figcaption>获取模型名称</figcaption></figure>
      <h4>3. 确认 Base URL</h4>
      <p>cc-Switch 的 Claude Provider 这里填写词元.fast 接口地址：</p>
      <pre><code>Base URL: https://ciyuan.fast
API Key: 你的词元.fast API Key
模型名称: 词元.fast 控制台中可用的模型 ID</code></pre>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-11.png" alt="CC Switch 确认 Base URL" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-11.png"><figcaption>确认 Base URL</figcaption></figure>
      <h3>本地环境配置指南</h3>
      <h4>1. 添加供应商</h4>
      <p>回到 cc-Switch 客户端，点击添加新的服务供应商。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-12.png" alt="CC Switch 添加供应商" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-12.png"><figcaption>添加供应商</figcaption></figure>
      <h4>2. 填写配置信息</h4>
      <p>按照图中入口进入配置页面，向下滚动，把刚才准备好的词元.fast 凭证填入对应位置。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-13.png" alt="CC Switch 进入 Provider 配置" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-13.png"><figcaption>进入配置页面</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-14.png" alt="CC Switch 填写接口信息" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-14.png"><figcaption>填写接口信息</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-15.png" alt="CC Switch 填写模型信息" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-15.png"><figcaption>填写模型信息</figcaption></figure>
      <p>其他高级配置按需修改。最后核对 Provider 名称、Base URL、API Key 和模型名称，确认无误后点击添加。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-16.png" alt="CC Switch 核对并添加 Provider" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-16.png"><figcaption>核对并添加</figcaption></figure>
      <h4>3. 启动 Claude Code</h4>
      <p>重新打开 VS Code 中的 Claude Code 扩展。如果无需登录官方账号、直接进入对话窗口，说明本地配置已生效。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-17.png" alt="CC Switch 启动 Claude Code" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-17.png"><figcaption>启动 Claude Code</figcaption></figure>
      <h3>远程环境（Remote - SSH）配置指南</h3>
      <h4>1. 开启本地代理服务</h4>
      <p>如果你通过 VS Code Remote - SSH 在远程服务器里使用 Claude Code，需要先在本机 cc-Switch 中开启本地代理，并记住生成的服务地址与端口。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-18.png" alt="CC Switch 开启本地代理 1" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-18.png"><figcaption>开启本地代理</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-19.png" alt="CC Switch 开启本地代理 2" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-19.png"><figcaption>记录代理地址</figcaption></figure>
      <h4>2. 验证代理状态</h4>
      <p>点击图中入口打开终端，在 Windows 终端执行下面命令。如果打开的配置文件中包含代理信息，说明代理开启成功，复制红框里的内容备用。</p>
      <pre><code>notepad "%USERPROFILE%\\.claude\\settings.json"</code></pre>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-20.png" alt="CC Switch 打开终端" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-20.png"><figcaption>打开终端</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-21.png" alt="CC Switch 复制代理配置" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-21.png"><figcaption>复制代理配置</figcaption></figure>
      <h4>3. 配置 Remote - SSH 端口转发</h4>
      <p>确认 VS Code 已安装 Remote - SSH 插件。编辑 SSH 连接配置文件，为目标服务器添加 <code>RemoteForward</code>，把远程端口转发到本机 cc-Switch 代理端口。</p>
      <pre><code>RemoteForward 127.0.0.1:代理端口 127.0.0.1:本机代理端口</code></pre>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-22.png" alt="CC Switch 编辑 SSH 配置 1" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-22.png"><figcaption>编辑 SSH 配置</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-23.png" alt="CC Switch 编辑 SSH 配置 2" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-23.png"><figcaption>添加 RemoteForward</figcaption></figure>
      <h4>4. 配置远程 Claude Code 扩展</h4>
      <p>在远程服务器上安装 Claude Code 扩展，然后进入扩展环境配置，把前面复制的代理地址和密钥填入对应字段。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-24.png" alt="CC Switch 安装远程 Claude Code 扩展" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-24.png"><figcaption>安装远程扩展</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-25.png" alt="CC Switch 配置远程扩展" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-25.png"><figcaption>配置远程扩展</figcaption></figure>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-26.png" alt="CC Switch 写入远程代理地址" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-26.png"><figcaption>写入代理地址</figcaption></figure>
      <h4>5. 完成配置并运行</h4>
      <p>点击远程环境里的 Claude Code 图标。如果直接进入对话界面，说明远程配置成功。</p>
      <figure class="shot doc-shot"><img src="images/cc-switch/claude-code-tutorial-111.png" alt="CC Switch 远程运行完成" loading="lazy" data-full="images/cc-switch/claude-code-tutorial-111.png"><figcaption>远程运行完成</figcaption></figure>
      <h2>安装方式</h2>
